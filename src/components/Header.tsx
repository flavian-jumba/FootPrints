      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center">
            <img src="/images/logo.png" alt="Footprints of Hope Logo" className="h-12" />
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            {navigationItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-sm font-medium text-white hover:text-gray-200 transition-colors duration-200 relative group"
              >
                {item.name}
          ...
          <div className="flex items-center space-x-4">
            <Button className="bg-[#d91e98] hover:bg-[#b81b82] text-white hidden sm:inline-flex">
              Donate Now
            </Button>
        ...
        {isMenuOpen && (
          <div className="lg:hidden py-4 animate-fade-in-up">
            <nav className="flex flex-col space-y-4">
              ...
              <Button className="bg-[#d91e98] hover:bg-[#b81b82] text-white mt-4 w-full sm:hidden">
                Donate Now
              </Button>
            </nav>
          </div>
